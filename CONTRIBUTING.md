# Contributing to NoriTrans

Thank you for helping improve NoriTrans. Before contributing, please read
...
`WXT_NORITRANS_SITE_DIAGNOSTICS=1`. Diagnostics may include truncated media
