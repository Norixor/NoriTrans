...
const strictEnvironment = {
  ...process.env,
  NORIXORTRANS_OCR_CAPTURE_E2E: "1",
};
if (!process.env.NORIXORTRANS_OCR_RUNTIME_DIR?.trim()) {
  process.stdout.write(
    "OCR headed E2E skipped: set NORIXORTRANS_OCR_RUNTIME_DIR to the directory containing the three pinned English runtime files.\n",
  );
  process.exit(0);
}
const productionEnvironment = { ...process.env };
delete productionEnvironment.NORIXORTRANS_OCR_CAPTURE_E2E;
